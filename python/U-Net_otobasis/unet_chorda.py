...
#
def get_unet_512_weighted(input_shape=(512, 512, 3),
				num_classes=1):
	...
	weighted_loss = losses.class_weighted_cross_entropy_3(class_weights);
...
# \brief Symmetric Unet sfor shapes 512,512
#
def get_unet_512_binary(input_shape=(512, 512, 3),
				num_classes=1):
	inputs = Input(shape=input_shape)
	# 512
	...
	model.compile(optimizer=RMSprop(lr=0.0001), loss='binary_crossentropy', metrics=[losses.dice_coeff])
	return model
...
# ===========================================================================
# \brief 
def get_unet_128_512_binary(input_shape=(128, 512, 3), num_classes=1):    
	inputs = Input(shape=input_shape)
	# 128
	down1 = Conv2D(64, (3, 3), padding='same')(inputs)
	down1 = BatchNormalization()(down1)
