import os
import predict_xy as predict
	
# ===========================================================================
# \brief 
#
def test_xy_init_model(num_classes, model_date):
	print("=========== Predicting XY ===============")
	...
	if use_model_one:
		...
		predict.predict_on_dataset(model_base_dir, model_dir, raw_data_dir, out_dir, predict_first_dataset, num_classes);
