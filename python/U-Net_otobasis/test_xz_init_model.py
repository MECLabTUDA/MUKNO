...
# \brief 
#
def test_xz_init_model(num_classes, model_date):
	print("=========== Predicting XZ ===============")
	...
	if use_model_one:
		...
		predict.predict_on_dataset_xz(model_base_dir, model_dir, raw_data_dir, out_dir, predict_first_dataset, num_classes);
