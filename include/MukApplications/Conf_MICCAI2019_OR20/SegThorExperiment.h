    ...
    */
    class SegThorExperiment : public Experiment
    {
      ...
      private:
        struct CuttingInfo
        {
          Vec3d  position; // RA = Right Atrium, RV = Right Ventricle
          double radius;
        };
      ...
      private:
        ...
        std::string mOriginalDataBasePath;
        ...
        std::string mUnetResultDir;    /// predictions of latest unet run lie here
