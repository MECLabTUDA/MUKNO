...
namespace gris
{
  namespace muk
  {
    ...
    */
    void gris::muk::TabSelection::updateComponentCount(bool ctFileLoaded, bool tabIsSmall)
    {
    ...
    */
    void gris::muk::TabSelection::updateObstacleCount(bool tabIsSmall, std::vector<std::string> activeObstacleKeys, std::vector<QColor> colors)
    {
    ...
    */
    void gris::muk::TabSelection::updateComponentWeights(std::vector<double> weights)
    {
      auto* componentScene = findChild<ParameterNet*>("Graphic Scene Component");
    ...
    */
    void gris::muk::TabSelection::updateObstacleWeights(std::vector<double> weights)
    {
      auto* obstacleScene = findChild<ParameterNet*>("Graphic Scene Obstacle");
      for (size_t i(0); i < weights.size(); i++)
      {
    ...
    */
    void gris::muk::TabSelection::updateComponentFilter(std::vector<double> sliderValue, std::vector<double> filterValue, std::vector<double> filterMin, std::vector<double> filterMax)
    {
    ...
    */
    void gris::muk::TabSelection::updateObstacleFilter(std::vector<double> sliderValue, std::vector<double> filterValue, std::vector<double> filterMin, std::vector<double> filterMax)
    {
    ...
    */
    void gris::muk::TabSelection::resetTabSelection()
    {
    ...
    */
    double gris::muk::TabSelection::getCutOffDistance(size_t canalInd)
    {
    ...
    */
    void gris::muk::TabSelection::checkAccessCanals(std::vector<size_t> chosenIdx)
    {
    ...
    */
    void gris::muk::TabSelection::toggleAsObstacle(bool on, size_t canalInd)
    {
    ...
    */
    void gris::muk::TabSelection::updateCutOffDistance(size_t canalInd, double distance)
    {
      auto spinbox = findChild<QDoubleSpinBox*>(QString("cutOffDistanceSpinBox %1").arg(canalInd));
