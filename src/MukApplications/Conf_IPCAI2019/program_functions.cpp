...
namespace muk
{
  ...
  */
  ...
  {
    auto fn = "../resources/MukApplications/Conf_IPCAI2019/PatientData.mukcfg";
    auto doc = XmlDocument::create("Mukno");
    auto& root = doc->getRoot();
    root.addChild("ImageRootDir").setValue("M:/MUKNO2/Rohdaten/data/preoperative/general/");
    root.addChild("SceneRootDir").setValue("../data/scenes/Conf_IPCAI2019/");
  ...
  */
  void extractObstacles(const ProgramInput& input)
  {
    ...
    const auto& outDir = input.cochleaData.outputDir;
  ...
  */
  void evaluateStatistics()
  {
    ...
    auto dir = fs::path("../results/MukApplications/Conf_IPCAI2019/label_statistics/");
